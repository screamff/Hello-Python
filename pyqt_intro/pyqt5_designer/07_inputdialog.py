...
# Form implementation generated from reading ui file '.\07_inputdialog.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(self.get_dialog)

    def get_input(self):
        str_dialog, ok = QtWidgets.QInputDialog.getText(MainWindow, "输入框", "输入内容")
        if ok:
            print("ok",str_dialog)
        else:
            print("cancel")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "get_sdin"))
